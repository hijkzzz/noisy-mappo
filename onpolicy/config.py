...
def get_config():
    ...
    # advantage noise
    parser.add_argument("--use_adv_noise",  action='store_true', default=False, help="")
    parser.add_argument("--alpha", default=0.05, type=float, help="")
    
    # value noise
    parser.add_argument("--use_value_noise",  action='store_true', default=False, help="")
    parser.add_argument("--reset_interval", type=int, default=-1, help="")
    parser.add_argument("--sigma", default=1, type=float, help="")
    parser.add_argument("--noise_dim", default=10, type=int, help="")
