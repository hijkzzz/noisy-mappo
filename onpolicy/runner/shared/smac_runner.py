    ...
    def run(self):
        ...
        for episode in range(episodes):
            ...
            for step in range(self.episode_length):
                # Sample actions
                values, actions, action_log_probs, rnn_states, rnn_states_critic = self.collect(step, self.noise_vector)
            ...
            self.compute(self.noise_vector)
            ...
            if episode % self.log_interval == 0:
                ...
                print("\n Map {} Algo {} Exp {} updates {}/{} episodes, total num timesteps {}/{}, FPS {}.\n"
                 ...
                 # print loss
                print('value_loss:{:.6f}\t policy_loss:{:.6f}\t dist_entropy:{:.6f}\t imp_weights:{:.6f}\t actor_grad_norm:{:.6f}\t critic_grad_norm:{:.6f}'.format(
                                                                            train_infos['value_loss'],
